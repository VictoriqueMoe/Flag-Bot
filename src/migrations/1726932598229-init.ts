...
export class Init1726932598229 implements MigrationInterface {
    name = 'Init1726932598229'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "guildable_model" ("guildId" varchar PRIMARY KEY NOT NULL)`);
        await queryRunner.query(`CREATE TABLE "settings_model" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "guildId" varchar NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "setting" text NOT NULL, "value" varchar NOT NULL)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_settings_model" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "guildId" varchar NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "setting" text NOT NULL, "value" varchar NOT NULL, CONSTRAINT "FK_2213011cb8d55ed70e2ad86c339" FOREIGN KEY ("guildId") REFERENCES "guildable_model" ("guildId") ON DELETE CASCADE ON UPDATE CASCADE)`);
